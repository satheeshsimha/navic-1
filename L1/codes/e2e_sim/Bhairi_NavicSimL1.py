...
for i in range(satVis):
    ...
    if(pilot_overlay_sent[lckdidx,i]!=overlay[lckdidx]):
        ...
        print("Subframe1 Before Encoding (9 bits):",navic_raw_data[:9,i])
        #print("Subframe1 After Encoding (52 Symbols):",navbits[:52,i])
        #print("Subframe1 After Receiving (52 Symbols):",bits[:52])
        print("Subframe1 After decoding (9 bits):",s1_decoded)
        print("Subframe2 Before Encoding (600 bits):",navic_raw_data[9:609,i])
        #print("Subframe2 After Encoding (1200 Symbols):",navbits[52:1252,i])
        #print("Subframe2 After Receiving (1200 Symbols):",bits[52:1252])
        print("Subframe2 After decoding (600 bits):",s2_decoded)
        print("Subframe 2 is same before encoding and after decoding:",np.all(navic_raw_data[9:609,i]==s2_decoded))
        ...
        print("Subframe3 Before Encoding (274 bits):",navic_raw_data[609:,i])
        #print("Subframe3 After Encoding (548 Symbols):",navbits[1252:,i])
        #print("Subframe3 After Receiving (548 Symbols):",bits[1252:])
        print("Subframe3 After decoding (274 bits):",s3_decoded)
        print("Subframe 3 is same before encoding and after decoding:",np.all(navic_raw_data[609:,i]==s3_decoded))
