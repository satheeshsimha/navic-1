...
fShift = np.array([830,640,490,670])
...
sigDelay = np.array([32196.9, 151526.23, 34256.66,99132.43])
...
for istep in range(numSteps):
    ...
    #waveform = np.append(waveform, rxwaveform)
