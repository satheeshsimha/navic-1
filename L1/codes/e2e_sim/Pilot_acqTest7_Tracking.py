...
class NavicTracker:
    ...
    def stepImpl(self, u):
       ...
       # if (round(self.SampleRate*integtime) == round(self.pNumSamplesToAppend)):
        #    self.pBuffer = u
        #else :
...
for i in range(satVis):
    ...
    num_sf = len(bits)//600
    navbits = datagen.GetBitStream()[0:600+num_sf*600,i].reshape(-1,600)
