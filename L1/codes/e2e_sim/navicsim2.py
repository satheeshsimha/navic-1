...
def genNavicCaTable_Data(samplingFreq):
    prnIdMax = 64
    codeLength = 10230
...
def genNavicCaTable_Pilot(samplingFreq):
    prnIdMax = 64
    codeLength = 10230
    codeFreqBasis = 1.023e6
    samplingPeriod = 1/samplingFreq
...
def genNavicCaTable_Pilot_Overlay(samplingFreq):
    prnIdMax = 64
    codeLength = 1800
    codeFreqBasis = 100
    samplingPeriod = 1/samplingFreq
...
class NavicTracker:
    ...
    def setupImpl(self):
        ...
        code = 1 - 2 * genNavicCaCode_data(self.PRNID).astype(float)
