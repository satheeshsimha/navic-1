...
def navic_pcps_acquisition(x, prnSeq_pilot, prnSeq_data, fs, fSearch,coherent_integ, non_coherent_integ, K1,if_frequency,threshold=100):
...
class NavicTracker:
    def __init__(self, prnId ):
        ...
        #Kalaman Filter Settings for Phase Error estimate
        self.state_estimate_phase = 0.0
        self.state_covariance_phase = 1.0
        self.process_covariance_phase = 0.5**2 #0.01**2
        self.measurement_covariance_phase = 1*2 #0.1**2
        ...
        self.early_late_spacing = 0.1
        self.very_early_very_late_spacing = 0.45
    ...
    def setupImpl(self, dataCodeLength, U, cn0_min, detector_threshold, lock_fail_counter_threshold):
        ...
        if self.DLLOrder == 1: # Table 8.23 in Kaplan 3rd edition [1]
            ...
            # self.pDLLGain1 = 1.5#1.891891892
            # self.pDLLGain2 = 1#.353351351
        ...
        #self.prnCode_InitialSetup()  # Create subcarrier * prncode
    ...
    def finedealy_correction(self,samp):
        ...
        #local_samp = np.copy(samp) #copy samp  to the dummy array
    ...
    def stepImpl(self, u, iter):
        ...
        #print(iter,"currnsamp=",self.currnsamp,"remcode=",self.remcode_pilot,"code freq=",self.codeFreq,"\n")
        ...
        #phases = (2*np.pi*self.carrfreq*t + self.old_remcarr )
        ...
        #carrier aiding DLL */
        self.codeFreq = self.ChipRate - self.pDLLNCOOut #+ (fc - self.CenterFrequency) * self.ChipRate / 1575420000
...
def file_read(file, sample_count):
    ...
    #waveform1 = waveform * np.exp(-1j*2*np.pi*if_frequency*t_lowerSample_Rate) # Remove IF frequency
